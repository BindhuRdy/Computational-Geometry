...
public class CompGeomTest extends Frame
{
  ...
  private MenuItem area, tri, inpoly, segseg, chull, delTri, poly2inters, mink, oarmmove, polydecomp;
  ...
  public CompGeomTest(Applet a)
  {
      ...
      polydecomp = new MenuItem("Polygon Decomposition");
      help = new Menu ("Help");
