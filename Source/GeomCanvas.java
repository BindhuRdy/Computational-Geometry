...
public class GeomCanvas extends Canvas
{
		...
		if (toPaint) {
			...
			{    
				...
				if(hertelmehlhorntri == true){
					...
					Pol.dcel.DrawDiagonals(gContext, inColor);
					Pol.ClearDCEL();
				}
				else{
					Pol.diaglist.DrawDiagonals(gContext, inColor);
					Pol.ClearDiagList();
				}
	...
	{
		trian = true;
        //setting hertelmelhorn to false in case of existing triangulation action..
...
//Trangulating and applying hertel melhorn algorithm for polygon decomposition 
